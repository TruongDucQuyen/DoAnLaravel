        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="{{route('tin-tuc')}}" class="nav-item nav-link active">Tin Tức</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="position-relative mb-3">
                                <img class="img-fluid w-100" src="{{asset('tintucimages/')}}/{{$tinTuc->hinh_anh}}"
                                    style="object-fit: cover; height: 250px;">
                                <div class="bg-white border border-top-0 p-4">
                                    <div class="mb-2">
                                        <small>{{$tinTuc->thoi_gian}}</small>
                                    </div>
                                    <a class="h4 d-block mb-3 text-secondary text-uppercase font-weight-bold"
                                        href="/chi-tiet-tin-tuc1/{{$tinTuc->id}}">{{$tinTuc->tieu_de}}</a>
                                </div>
                                <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                                    <div class="d-flex">
                                        <small>Người đăng : {{$tinTuc->ten_nguoi_dang}}</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pagination">
                            {{$dsTinTuc->links('vendor\pagination\bootstrap-4')}}
                        </div>
                    </div>
                </div>
