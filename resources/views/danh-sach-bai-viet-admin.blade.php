        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{route('danh-sach-bai-viet-admin')}}" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Danh sách bài viết</a>
                ...
                <div class="row g-4">
                    <div class="">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Danh sách bài đăng</h6>
                            <table class="table">
                                <thead>
                                ...
                                <tbody>
                                    ...
                                    <tr style="text-align:center">
                                        ...
                                        <td>{{$baiDang->noi_mat}}</td>
                                        <td>{{$baiDang->thong_tin_lien_he}}</td>
                                        <td>{{$baiDang->thoi_gian}}</td>
                                        <td>
                                        <a href="{{route('baidang.xoa',['id'=>$baiDang->id])}}">Xóa</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
