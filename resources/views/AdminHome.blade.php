        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{route('AdminHome')}}" class="nav-item nav-link active"><i
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-1">
                            ...
                            <a href="{{route('danh-sach-user')}}" class="dropdown-item">User</a>
                        </div>
                    </div>
                    <a href="{{'danh-sach-bai-viet-admin'}}" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Danh
                        sách bài viết</a>
                    <a href="{{route('danh-sach-tin-tuc-admin')}}" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Danh sách tin tức</a>
                    <a href="{{route('dang-tin-tuc-admin')}}" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Đăng tin tức mới</a>
                    <a href="{{route('danh-sach-report')}}" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Report</a>
            ...
            <div class="container-fluid pt-5 px-4">
                ...
                <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Bài Đăng Chờ Duyệt</p>
                                <h6 class="mb-0">
                                    {{$baiDangChoDuyet}}
                                </h6>
                            </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            <i class="fa fa-chart-line fa-3x text-primary"></i>
                            <div class="ms-3">
                                <p class="mb-2">Bài Đăng Trong Ngày</p>
                                <h6 class="mb-0">
                                    {{$baiDang}}
                                </h6>
                            </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Bài Đăng Trong Tháng</p>
                                <h6 class="mb-0">
                ...
                <div class="row g-4">
                    <div class="">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Danh sách bài đăng chưa duyệt</h6>
                            <table class="table">
                                <thead>
                                ...
                                <tbody>
                                    ...
                                    <tr style="text-align:center">
                                        ...
                                        <td>
                                            ...
                                            <a style="color:black"href="{{route('admin.chi-tiet-bai-dang-chua-xl',['id'=>$baiDang->id])}}">Chi
                                                Tiết</a>
                                            </button>
                                        </td>
