        ...
        $('.delete').click(function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.get($(this).attr('href'));
                    window.location.replace('danh-sach-user');
                }
            })
        })
    })
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown active">
                        ...
                        <div class="dropdown-menu bg-transparent border-0 nav-item nav-link">
                            ...
                            <a href="{{route('danh-sach-user')}}"
                                class="dropdown-item nav-item nav-link active">Users</a>
                        </div>
                    </div>
                ...
                <div class="row g-4">
                    <div class="">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Danh sách tài khoản User</h6>
                            <table class="table">
                                <thead>
                                    ...
                                    <tr style="text-align:center">
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-info order"><a style="color:white"
                                                ...
                                                class="btn btn-danger order"><a style="color:white"
                                                    href="{{route('admin.xoa',['id'=>$adMin->id])}}"
