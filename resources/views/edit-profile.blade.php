        ...
        <div class="row">
            <div class="col-md-3 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                    ...
                    <?php }?>
                    <span class="font-weight-bold">{{Auth::user()->ten_dang_nhap}}</span><span> </span>
                </div>
            </div>
            <div class="col-md-5 border-right">
                <div class="p-3 py-5">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="text-right">Chỉnh Sửa Thông Tin Tài Khoản</h4>
                    </div>
                    <div class="row mt-3" style="text-align:left">

                        <form action="{{route('xl-cap-nhat',['id'=>Auth::user()->id])}}" method="POST">
                            @csrf
                            <div class="col-md-12"><label class="labels mt-2">Họ tên</label><input type="text"
                                    class="form-control" placeholder="" value="{{Auth::user()->ho_ten}}" name="ho_ten">
                            </div>
                            <div class="col-md-12"><label class="labels mt-2">Email</label><input type="text"
                                    class="form-control" placeholder="" value="{{Auth::user()->email}}" name="email">
                            </div>
                            <div class="col-md-12"><label class="labels mt-2">Số điện thoại</label><input type="text"
                                    class="form-control" placeholder="" value="{{Auth::user()->phone}}" name="phone">
                            </div>
                            <div class="col-md-12"><label class="labels mt-2">Địa chỉ</label><input type="text"
                                    class="form-control" placeholder="" value="{{Auth::user()->address}}"
                                    name="address"></div>
