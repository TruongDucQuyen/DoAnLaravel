                ...
                <div class="row g-4">
                    <div class="">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h1 style="color:red">Chi tiết Report</h1> <br>
                                <h6>Tên người Report : {{$dsReport->tennguoi_report}}</h6>
                                <h6 >Nội dung Report : {{$dsReport->noi_dung_report}}</h6>
                                <br> <br>
                                <a href="{{route('danh-sach-report')}}"> << Trở lại </a>
                        </div>
                    </div>
                </div>
            </div>
