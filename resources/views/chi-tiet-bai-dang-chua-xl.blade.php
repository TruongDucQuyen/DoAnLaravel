...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <!-- Table Start -->
            <div class="container pt-4 px-4 ml-5">
                <div class="row g-4">
                    <div class="">
                        <h1>CHI TIẾT BÀI ĐĂNG </h1>
                        <br>
                        <form action="{{route('admin.xl-duyet-bai',['id'=>$baiDang->id])}}" method="POST">
                            @csrf
                ...
                ?>
                                ...
                                <tr>
                                    <td>Liên hệ</td>
                                    <td>
                                        {{$baiDang->thong_tin_lien_he}}
                                    </td>
                                </tr>
                                <tr>
                                    <td>Hình ảnh</td>
                                    <td>
                                        <img class="img-fluid w-100" src="{{asset('images/')}}/{{$baiDang->hinh_anh}}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="submit" class="btn btn-primary mt-3 mr-20">Duyệt</button>
                                    </td>
                                </tr>
                            </table>
                        </form>
