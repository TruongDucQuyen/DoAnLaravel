...
<body>
    ...
    <div class="baidang">
        <form action="{{route('xl-chinh-sua-bai-dang',['id'=>$baiDang->id])}}" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="form-group">
                <h5>Tiêu đề : <input type="text" class="ml-2" name="tieu_de" value="{{$baiDang->tieu_de}}"></h5>
            </div>
            <div class="form-group">
                <h5>Loại tin : </h5>
                <?php if($baiDang->loai_tin==0){ ?>
                <input name="loai_tin" type="radio" value="0" checked> Tin mất đồ <br>
                <input name="loai_tin" type="radio" value="1"> Tin nhặt đồ
                <?php }else {?>
                <input name="loai_tin" type="radio" value="0"> Tin mất đồ <br>
                <input name="loai_tin" type="radio" value="1" checked> Tin nhặt đồ
                <?php }?>
            </div>
            <div class="form-group">
                <h5>Nội dung :</h5>
                <textarea name="noi_dung" id="" cols="37" rows="5">{{$baiDang->noi_dung}}</textarea>
            </div>
            <div class="form-group">
                <h5>Nơi mất : <input type="text" class="ml-2" name="noi_mat" value="{{$baiDang->noi_mat}}"></h5>
            </div>
            <div class="form-group">
                <h5>Thông tin liên hệ : </h5>
                <textarea name="thong_tin_lien_he" id="" cols="37" rows="3">{{$baiDang->thong_tin_lien_he}}</textarea>
            </div>
            <div id="content-2">
                <h4 class="tm-text-primary mt-2">Chọn hình</h4>

                <img src="{{asset('images/')}}/{{$baiDang->hinh_anh}}" alt="" id="image" width="250px" height="250px">
