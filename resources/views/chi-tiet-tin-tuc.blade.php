                ...
                <div class="row g-4">
                    <div class="">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h1 style="color:red">Chi tiết tin tức</h1> <br>
                            @foreach($detail as $dt)
                            <h3>Tiêu đề : {{$dt->tieu_de}}</h3>
                            <h3>Nội dung: <br> <textarea name="" id="" cols="60" rows="8"
                                    disabled>{{$dt->noi_dung}}</textarea></h3>
                            <h3>Hình ảnh</h3> <img class="img-fluid w-100" src="{{asset('tintucimages/')}}/{{$dt->hinh_anh}}"
                                style="object-fit: cover;">
                            @endforeach
                            <br> <br>
                            <a href="{{route('danh-sach-tin-tuc-admin')}}"> << Trở lại</a>
                        </div>
                    </div>
                </div>
            </div>
