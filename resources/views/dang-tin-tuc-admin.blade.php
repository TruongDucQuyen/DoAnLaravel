    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{route('dang-tin-tuc-admin')}}" class="nav-item nav-link active"><i
        ...
        <div class="content">
            ...
            <div class="container pt-4 px-4">
                <div class="row g-4">
                    <div class="">
                        <div class="bg-secondary rounded h-100 p-4" style="text-align:center">
                            <h1 style="color:red">Đăng tin tức</h1>
                            <div class="baidang">
                                <form action="{{route('xl-dang-tin')}}" enctype="multipart/form-data" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <h5>Tiêu đề : <br> <textarea name="tieu_de" id="" cols="37" rows="2"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <h5>Nội dung :</h5>

                                       <textarea name="noi_dung" id="" cols="70" rows="10"></textarea>
                                    ...
                                    <div class="form-group tm-text-right">
                                        <button type="submit" class="btn btn-primary mt-3">Đăng Tin Tức</button>
                                    </div>
                                </form>
                            </div>
                        </div>
