                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title">
                                <h4 class="m-0 text-uppercase font-weight-bold">Kết Quả Tìm Kiếm: <h6>Từ Khóa: " {{$search}} "</h6></h4>
                            </div>
                        </div>
                        @foreach($dsSearch as $data)
                        @if($data!=null)
                        <div class="col-lg-6">
                        ...
                        <div class="pagination">
                            {{$dsSearch->links('vendor\pagination\bootstrap-4')}}
                        </div>
                    </div>
                </div>
                <!-- Right -->
