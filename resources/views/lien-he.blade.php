                ...
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <?php if(Auth::user()){ ?>
                            ...
                            <?php } else{ ?>
                                {{route('dang-nhap')}}
                                <?php } ?>
                    " class="nav-item nav-link">Đăng Bài</a>
                    ...
                    <a href="{{route('lien-he')}}" class="nav-item nav-link active">Liên Hệ</a>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="section-title mb-0">
                        <h4 class="m-0 text-uppercase font-weight-bold">Thông Tin Liên Hệ</h4>
                    </div>
                    <div class="bg-white border border-top-0 p-4 mb-3">
                        <div class="mb-4">
							<div class="mb-3">
                                ...
                                <p class="m-0">65 Huỳnh Thúc Kháng,P.Bến Nghé,Q.1,Tp.HCM</p>
                            </div>
                            <div class="mb-3">
                                <div class="d-flex align-items-center mb-2">
                                ...
                                <p class="m-0">0306201374@caothang.edu.vn</p>
                            </div>
                            <div class="mb-3">
                                <div class="d-flex align-items-center mb-2">
    ...
    <div class="container-fluid bg-dark pt-5 px-sm-3 px-md-5 mt-5">
        <div class="row py-4">
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p class="font-weight-medium"><i class="fa fa-map-marker-alt mr-2"></i>65 Huỳnh Thúc Kháng,P.Bến Nghé,Q.1,Tp.HCM</p>
                <p class="font-weight-medium"><i class="fa fa-phone-alt mr-2"></i>028 38 212 868</p>
                <p class="font-weight-medium"><i class="fa fa-envelope mr-2"></i>0306201374@caothang.edu.vn</p>
