            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="{{asset('avatars/')}}/{{Auth::user()->image}}" alt=""
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown active">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{route('danh-sach-admin')}}" class="dropdown-item nav-item nav-link active">Admin</a>
                            <a href="{{route('danh-sach-user')}}" class="dropdown-item">Users</a>
                        </div>
                    </div>
                    <a href="{{route('danh-sach-bai-viet-admin')}}" class="nav-item nav-link"><i
                            class="fa fa-th me-2"></i>Danh sách bài viết</a>
                ...
                <div class="row g-4">
                    <div class="">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h1>CHỈNH SỬA TÀI KHOẢN {{$adMin->ten_dang_nhap}}</h1>
                            <br>
                            <form action="{{route('admin.xl-cap-nhat',['id'=>$adMin->id])}}" method="POST">
                                @csrf
                                <table>
                                    <tr>
                                        <td>Tên đăng nhập</td>
                                        <td>
                                            <input type="text" name="ten_dang_nhap" value="{{$adMin->ten_dang_nhap}}">
                                        </td>
                                    <tr>
                                        <td>Họ tên</td>
                                        <td>
                                            <input type="text" name="ho_ten" value="{{$adMin->ho_ten}}">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Email</td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td><button type="submit" class="btn btn-primary mt-3">Lưu</button></td>
                                    </tr>
                                </table>
                            </form>
                        </div>
